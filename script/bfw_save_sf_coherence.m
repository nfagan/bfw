...
defaults.trial_average_specificity = { 'roi', 'looks_by' };
...
coh_file = bfw.make.raw_sfcoherence( files ...
  ...
  , 'trial_average', true ...
  , 'trial_average_specificity', params.trial_average_specificity ...
  , 'event_window_average', params.event_window_average ...
);
