...
results = loop_runner.run( @make_raw_rois_main, loop_runner.output_directory, params );

end

function rois = make_raw_rois_main(files, unified_filename, output_directory, params)
